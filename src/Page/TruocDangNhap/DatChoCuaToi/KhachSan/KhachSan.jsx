        ...
        <div className="Body">
            ...
            <div className="Body_DCCT">
                ...
                <div className="Body_DCCT_Right">
                    <div className="box_ks">
                        <div className="box_ks_txt1">Sau khi gửi biểu mẫu bên dưới, chúng tôi sẽ gửi vé điện tử trực tiếp đến địa chỉ email bạn đã sử dụng khi đặt chỗ. Biểu mẫu này cũng có thể sử dụng để hoàn thành các giao dịch chưa thanh toán của bạn.</div>
                        <div className="box_vmb_txt2">Khôi phục đặt chỗ</div>

                        <div className="box_ks_bottom">
                            <div className="box_ks_bottom_7dGjd">
