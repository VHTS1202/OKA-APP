            ...
            <div className='_form1'>
                ...
                <div className="_form2">
                    <form>
                        ...
                        <div id="PN" className="_39bD-">Dùng email?</div>
                            ...
                            <div className="InputNumBer">
                                <div className="_2uESJ">
                                    <div className="input-form-phone">
                                        <div className="_34r8b _3-qgg" data-id="phonePrefix">
                                            <div className="_3mf_H">
                                                <div className="_2p9_i">
                                                    <div className="_1WlFv _1pXlI"></div>
                                                    <span className='span1'>+84</span></div>
                                                    <div className="_3ZwCM"></div>
                                                </div>
                                            </div>
                                            <div className="xSZ_Q">
                                                <div>
                                ...
                                <div className="_3jR7O">
                                    <button className="hkthB _3_ByF gLbQ- _1AdOq _90_75" id="registerBtn" type="button">Tham gia</button>
                                </div>
                            </div>
                            <div className="_2dHnL">Xin lưu ý bạn không cần nhập mã quốc gia.</div>
                            <div className="K6u2Z"></div>
                        </div>
                        <p className="_1L5c_">Bạn đã đăng ký? <a href="/#">Đăng nhập</a></p>
